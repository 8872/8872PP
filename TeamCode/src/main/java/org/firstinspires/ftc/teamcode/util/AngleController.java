...
public class AngleController {
     ...
     */
    public AngleController(double kp, double ki, double kd, double kf) {
     ...
     */
    public AngleController(double kp, double ki, double kd, double kf, double sp, double pv) {
        kP = kp;
        kI = ki;
        kD = kd;
        kF = kf;
    ...
    public void setSetPoint(double sp) {
        setPoint = sp;
        errorVal_p = Math.toDegrees(angleWrap(Math.toRadians(setPoint - measuredValue)));
    ...
    public double calculate(double pv) {
        ...
        if (measuredValue == pv) {
            ...
            errorVal_p = Math.toDegrees(angleWrap(Math.toRadians(setPoint - pv)));
            measuredValue = pv;
        }
